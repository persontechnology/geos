        ...
        <div class="container text-center">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th>Functions</th>
                        <th><a>IOS Safari</a><img src="{{ asset('webcodecamjs/css/safari-icon.png') }}"></th>
                        <th><a>Microsoft IE 11</a><img src="{{ asset('webcodecamjs/css/Internet_Explorer_9.png') }}"></th>
                        <th><a>MS Edge latest</a><img src="{{ asset('webcodecamjs/css/949320192f43b9d8.png') }}"></th>
                        <th><a>Chrome latest</a><img src="{{ asset('webcodecamjs/css/google-chrome.png') }}"></th>
                        <th><a>Firefox latest</a><img src="{{ asset('webcodecamjs/css/mozilla_firefox.png') }}"></th>
                        <th><a>Opera latest</a><img src="{{ asset('webcodecamjs/css/opera.png') }}"></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
